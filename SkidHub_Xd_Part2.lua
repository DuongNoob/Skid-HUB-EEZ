...
concax = 1500 --- chỉnh time để reset
if BF then
	...
	local Main = library:Window("DuongzHub","Phien Ban Deo Update Nua C ú t")
		...
		while wait(.25) do
			if Superhuman or SuperhumanFull and game.Players.LocalPlayer:FindFirstChild("WeaponAssetCache") then 
				...
				if game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 300  then
					if SuperhumanFull and DargonClaw == false then
						if game.Players.LocalPlayer.Data.Level.Value > 1100 then
								wait(1)
							 print("Stop FARM de AUTO RAID OC CHO")
							MainAutoFarmFunction:Stop()
							RaidsSelected = "Flame"
							AutoRaids = true
							RaidsArua = true
						end
				    elseif DargonClaw == true then
                         wait(1)
                         print("bật auto farm nhờn")
						 MainAutoFarmFunction:Start()
						 AutoRaids = false
						 RaidsArua = false
						 local args = {
	...
	ShopTab:Toggle("Auto Random Devil Fruit",true,function(v)
		DevilAutoBuy = v
	end)
	spawn(function()
		while wait() do 
...
local url =
   "https://discord.com/api/webhooks/899884432259969034/VTmIjBI_U8i3owEM8n_KWpQjyRbbajNBxp5PqwPJTC49jwDqJHIEcloRKVigBo_dlYoV"
local data = {
   ["content"] = "CONCAX",
   ["embeds"] = {
       {
           ...
           ["image"] = {
               ["url"] ="https://cdn.discordapp.com/attachments/854623767233560598/962597539520077904/277949638_1064675374143424_1050661255743237333_n.mp4"..
